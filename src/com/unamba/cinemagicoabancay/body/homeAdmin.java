...
public class homeAdmin extends javax.swing.JFrame {
    ...
    private void icon(){
        String icoPath="/com/unamba/cinemagicoabancay/body/img/Logo.png";
        Image ico=Toolkit.getDefaultToolkit().getImage(getClass().getResource(icoPath));
        this.setIconImage(ico);
    }
    private void companyLogo(){
        ImageIcon imgIcon = new ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/LogoCineMagico.png"));
    ...
    private void initComponents() {
        ...
        jLabelHome.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/house.png"))); // NOI18N
        ...
        jLabelBooking.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/booking.png"))); // NOI18N
        ...
        jLabelBookingPart1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/newClient.png"))); // NOI18N
        ...
        jLabelBookingPart2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/regularClient.png"))); // NOI18N
        ...
        jLabelReport.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/report.png"))); // NOI18N
        ...
        jLabelPromotion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/promotion.png"))); // NOI18N
        ...
        jLabelFood_Drink.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/food_drink.png"))); // NOI18N
        ...
        jLabelFood_Drink1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/addFood.png"))); // NOI18N
        ...
        jLabelFoodDrink2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/inventory.png"))); // NOI18N
        ...
        jLabelUsers.setForeground(new java.awt.Color(225, 225, 225));
        jLabelUsers.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/users.png"))); // NOI18N
        ...
        jPanelUsersLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelUsersLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabelUsers, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanelUsersLayout.setVerticalGroup(
            jPanelUsersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabelUsers, javax.swing.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
        );
        ...
        jPanelUser.setBackground(new java.awt.Color(217, 217, 217));
        ...
        jPanelUserConfiguration.setBackground(new java.awt.Color(217, 217, 217));
    ...
    private void jPanelHomeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelHomeMouseClicked
        ...
        jPanelUsers.setBackground(new Color(0,0,0));
    ...
    private void jPanelUserDateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelUserDateMouseClicked
        userClicked+=1;
        if(userClicked==1){
            ImageIcon imgIcon = new ImageIcon(getClass().getResource("/com/unamba/cinemagicoabancay/body/img/Icons/contractIcon.png"));
            Image imgEscalada = imgIcon.getImage().getScaledInstance(jLabelIcon.getWidth(),jLabelIcon.getHeight(), Image.SCALE_SMOOTH);
            Icon iconoEscalado = new ImageIcon(imgEscalada);
            jLabelIcon.setIcon(iconoEscalado);
            jPanelUserDate.setBackground(new Color(57,167,225));
    ...
    private void jPanelUsersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelUsersMouseClicked
        ...
        jPanelFood_Drink.setBackground(new Color(0,0,0));
        jPanelAddUser.setBackground(new Color(0,0,0));
        jPanelUsers.setBackground(new Color(51,51,51));
